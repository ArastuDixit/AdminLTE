...
$result = mysqli_query($conn,"SELECT * FROM mailbox");
?>
<div>
...
$start_from=($page-1)*3;
$sql="SELECT * from mailbox limit $start_from,$num_per_page";
$result=$conn->query($sql);
...
echo "<li><a href='mailbox.php?page=".($page-1)."' class='button'>Previous&nbsp;</a></li>";
for($i=1;$i<=$total_pages;$i++){
	echo "<li><a href='mailbox.php?page=".$i."'>".$i."</a></li>";
};
echo "<li><a href='mailbox.php?page=".($page+1)."' class='button'>&nbsp;Next</a></li>";
echo "</ul>";
